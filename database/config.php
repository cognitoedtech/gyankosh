<?php
	class CConfig
	{
		...
		// - - - - - - - - - - - - - - - - - - - - - - - - - - -
		const SNC_SITE_NAME     = "QuizUs";
		const SNC_PUNCH_LINE    = "Test, Analyze, Improve, Repeat !";
		// - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        // - - - - - - - - - - - - - - - - - - - - - - - - - - -
        const SPR_BASIC     		= 0;
        const SPR_PROFESSIONAL		= 0;
        const SPR_ENTERPRISE 		= 0;
        const SPR_MINIMUM_TESTS		= 0;
        // - - - - - - - - - - - - - - - - - - - - - - - - - - -
		...
		// Official Email-IDs
		// - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
		const OEI_FINANCE		= "quizus.co@gmail.com";
		const OEI_SALES			= "quizus.co@gmail.com";
		const OEI_SUPPORT		= "quizus.co@gmail.com";
		const OEI_BUSI_ASSOC	= "quizus.co@gmail.com";
		const OEI_ABUSE			= "quizus.co@gmail.com";
		const OEI_FREE			= "quizus.co@gmail.com";
		// - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
		// Mail Configurations
		// - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
		...
		// - - - - - - - - - - - - - - - - - -
		// Never and Not Applicable constants
		// - - - - - - - - - - - - - - - - - -
		const CONST_NEVER			= 0;
		const CONST_NOT_APPLICABLE	= -1;
		// - - - - - - - - - - - - - - - - - -
        ...
        const EA_OPER_XLS_COPY  	= "#@QUIZUS_COPY";
        const EA_OPER_XLS_NA     	= "#@QUIZUS_NA";
        const EA_OPER_XLS_EMPTY 	= "#@QUIZUS_EMPTY";
        const EA_OPER_CODE_START 	= "#@QUIZUS_CODE_START";
        const EA_OPER_CODE_END 		= "#@QUIZUS_CODE_END";
