...
$objIncludeJsCSS->IncludeSRNavBarCSS ( "" );
			...
			<div class="col-lg-8 col-md-8 col-sm-8">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
						by <a href="search-results.php?company-name=<?php echo(urldecode($aryPublishedProduct['org_name']));?>&id=<?php echo($aryPublishedInfo['org_id']);?>"><?php echo($aryPublishedProduct['org_name']);?></a>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<span id="product-rating-user-1" data-score="1"></span> This is an
						awesome test by Prerna Arora
					</div>
