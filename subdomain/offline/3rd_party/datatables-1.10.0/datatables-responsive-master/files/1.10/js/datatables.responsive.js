...
ResponsiveDatatablesHelper.prototype.showHideColumns = function () {
    ...
    if(this.options.columnAryForHiding.length !== 0)
    {
    	for(var i = 0; i < this.options.columnAryForHiding.length; i++)
        {
        	this.api.column(this.options.columnAryForHiding[i]).visible(false);
        }
    }
};
