...
define('SECRET_SALT','cXzbWX8MtLvjZi8lcnQIbvZ1wGCzMLck');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','ritesh.kanoongo@ezeeassess.com');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','localhost');
define('DBNAME','ezeeassess_support');
define('DBUSER','root');
define('DBPASS','mipcat@racks123');
