...
<html>
	...
	<body>
		...
		<div class="container text-justify">
			<h3 class="text-center">Individual / Candidate : Frequently Asked Questions</h3><br/>
			<p>
				<b style="color:steelblue;">Qus 01: How can I register myself with <?php echo(CConfig::SNC_SITE_NAME);?>?</b><br/><br/>
				<b>Ans:</b> You can only get registered with us if you have an invite from any organization registered with us.
			</p><hr style="width:25%;"/>
			<p>
...
<p>
			...
			<p>
				...
				<b>Ans:</b> No, you can not design test for yourself. For designing tests you have to register as organization.
			</p><hr style="width:25%;"/>
			<p>
				<b style="color:steelblue;">Qus 06: Can I upload questions from my account?</b><br/><br/>
				<b>Ans:</b> No, you can not upload questions from your account. For contributing questions you have to register as organization.
			</p><hr style="width:25%;"/>
			<p>
				<b style="color:steelblue;">Qus 07: Will result analysis for finished tests be saved for future view?</b><br/><br/>
				<b>Ans:</b> Yes, it will be preserved and we don&rsquo;t have any policies in near future to remove those.
			</p><hr style="width:25%;"/>
			<p>
				<b style="color:steelblue;">Qus 08: If I am a part of Institute/Organization which is your client and they had registered me, can then I still be able register as a different Individual with same email id?</b><br/><br/>
				<b>Ans:</b> No, but you can register with different email id. 
			</p><hr style="width:25%;"/>
			<p>
				<b style="color:steelblue;">Qus 09: If I registered first with an email id, and same email id is used by an institute, then will personal account activity will be vanished?</b><br/><br/>
				<b>Ans:</b> No, your account activity will be preserved.
			</p><hr style="width:25%;"/>
			<p>
				<b style="color:steelblue;">Qus 10: If I attempt test and during the test timer expires but I did not get a chance to click on end exam, will my test be considered as submitted?</b><br/><br/>
				<b>Ans:</b> Yes, your test will be considered as submitted in that case.
			</p><hr style="width:25%;"/>
			<p>
				<b style="color:steelblue;">Qus 11: What if I want to finish the test earlier than time allotted or before timer expire?</b><br/><br/>
				<b>Ans:</b> You can finish/end the test by clicking on <b>End Exam</b> button.
			</p><hr style="width:25%;"/>
			<p>
				<b style="color:steelblue;">Qus 12: Can I change the choice of answer I have chosen initially?</b><br/><br/>
