...
<html>
	<head>
		...
		<title>Corporate : Frequently Asked Questions</title>
	...
	<body>
		...
		<div class="container text-justify">
			<h3 class="text-center">Organizations : Frequently Asked Questions</h3><br/>
			<p>
				<b style="color:steelblue;">Qus 01: How is <?php echo(CConfig::SNC_SITE_NAME);?> beneficial for Corporate/Employer?</b><br/><br/>
				<b>Ans:</b> <?php echo(CConfig::SNC_SITE_NAME);?> provides unique analysis tools for analyzing performance of candidates. Educational institutes can get exact area where candidate is week / strong, thus put focus on grooming accordingly. For recruitment drive, it provides complete Result Analysis of each candidate, thus helps out short listing of potential candidates just after the test (within seconds). This reduces overall cost, time and efforts of any organization. <?php echo(CConfig::SNC_SITE_NAME);?> is web-based application that removes the &quot;geographical boundaries&quot;. Organizations can design and schedule test to any for registered potential candidates. Candidate at remote place can also attempt test. You can use this tool to test performance of your existing employees as well.  
			</p><hr style="width:25%;"/>
			<p>
				<b style="color:steelblue;">Qus 02: How many types of result analysis <?php echo(CConfig::SNC_SITE_NAME);?> provides?</b><br/><br/>
				<b>Ans:</b> <?php echo(CConfig::SNC_SITE_NAME);?> provides summary level as well as detail level of analysis which is called <b>Result Data Analysis</b>.</b> 
			</p><hr style="width:25%;"/>
<p>
				<b style="color:steelblue;">Qus 03: Does <?php echo(CConfig::SNC_SITE_NAME);?> provides way to upload my questions?</b><br/><br/>
				<b>Ans:</b> Yes, you can upload your own questions or use our&rsquo;s. Based on your choice, test can be conducted from those questions only. 
			</p><hr style="width:25%;"/>
			<p>
			...
			<p>
				...
				<b>Ans:</b> Yes, we provided you pre-designed tests which can directly be scheduled from <b>Schedule Test</b> left navigation bar. This feature is under development and soon will be live.
			</p><hr style="width:25%;"/>
			<p>
				<b style="color:steelblue;">Qus 12: Can I reuse my designed test after I schedule it once?</b><br/><br/>
				<b>Ans:</b> Yes you can reuse your test as many times as you want. The test you design with <b>Test Design Wizard</b> is kind of a <b>Test Template</b> which adapts questions automatically based on parameter you have specified during design. 
			</p><hr style="width:25%;"/>
			<p>
			...
			<p>
				...
				<b>Ans:</b> No, candidates can&rsquo;t attempt the test before scheduled date - although they can attempt the test on and after the scheduled date and before expiry. However, you will have the information about the test attempted date and time and it is up to you whether to accept the test result or not.
			</p><hr style="width:25%;"/>
			<p>
			...
			<p>
				...
				<b>Ans:</b> We have a very robust and resilient <b>Disaster Control Machanism</b> deviced to deal with this kind of situation. In any of these cases, test progress is preserved and candidates can resume the test from same point where they left the test. 
			</p><hr style="width:25%;"/>
			<p>
			...
			<p>
				...
				<b>Ans:</b> Kind of, <?php echo(CConfig::SNC_SITE_NAME);?> team of trainiers has prepared a video tutorial series and that will help you getting trained for our services.
			</p><hr style="width:25%;"/>
			<p>
				<b style="color:steelblue;">Qus 28: If any student who is already registered with <?php echo(CConfig::SNC_SITE_NAME);?> (and not regisered with us), become part of our test process - can he/she again register with same email-id with us?</b><br/><br/>
			...
			<p>
				<b style="color:steelblue;">Qus 29: <?php echo(CConfig::SNC_SITE_NAME);?> has test resumption feature for students. How many times a user can resume same test?</b><br/><br/>
