...
<html>
	...
	<body style="font: 75% 'Trebuchet MS', sans-serif; margin: 5px;">
		...
		<div id="ba_trans_history">
			<ul>
				<li><a href="#tab1">Transaction Information</a></li>
			</ul>
			<div id="tab1">
				<table cellpadding="0" cellspacing="0" border="0" width="100%" class="display" id="example">
					<thead>
						<tr>
							<th><font color="#000000">Net Commision</font></th>
							<th><font color="#000000">Gross Commision</font></th>
							<th><font color="#000000">Service Tax Amount</font></th>
							<th><font color="#000000">TDS Amount</font></th>
							<th><font color="#000000">Payment Mode</font></th>
							<th><font color="#000000">Bank IFSC Code</font></th>
							<th><font color="#000000">Payment Ordinal</font></th>
							<th><font color="#000000">Payment Date</font></th>
						</tr>
					</thead>
					<?php
						$objBilling->PopulateBATransactionHistory($user_id);
					?>
					<tfoot>
						<tr>
							<th><font color="#000000">Net Commision</font></th>
	...
	<script type="text/javascript">
		$(window).load(function(){
			...
			$('#ba_trans_history').show();
			$('#ba_trans_history').tabs();
