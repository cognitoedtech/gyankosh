    ...
    $.fn.rowGrouping = function (options) {
        ...
        return this.each(function (index, elem) {
            ...
            function _fnGetCleanedGroup(sGroup) {
                ...
                sGroup = sGroup.toLowerCase().replace(/[\+]/g, "Plus");
                sGroup = sGroup.toLowerCase().replace(/[\#]/g, "Hash");
                sGroup = sGroup.toLowerCase().replace(/[^a-zA-Z0-9\u0080-\uFFFF]+/g, "-");
                return sGroup; //fix for unicode characters (Issue 23)
