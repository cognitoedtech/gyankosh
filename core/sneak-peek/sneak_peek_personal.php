...
<?php
	...
	$page_id = CSiteConfig::UAP_SNEAK_PEEK_PERSONAL;
?>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<title><?php echo(CConfig::SNC_SITE_NAME);?>: Personal Knowledge Base</title>
<?php 
		...
		<div class="col-lg-9 col-md-9 col-sm-9" style="border-left: 1px solid #ddd; border-top: 1px solid #ddd;height: 700px;">
		    ...
		    <div class="form-inline">
		        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
					...
					<?php
						$QuesInfoAry = $objDB->GetQuestionsInfo($user_id);
