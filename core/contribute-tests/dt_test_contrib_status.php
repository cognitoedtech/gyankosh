...
<html>
	...
	<body>
		...
		<div id="result_analytics" style="display:none; margin-left: -15px; margin-right: -15px; margin-bottom: -10px;">
			<ul>
				<li><a href="#tab1">Test : Contribution Status</a></li>
			</ul>
			<div id="tab1">
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%" style="display:none" class="display" id="dt_contrib_test_status">
			<thead>
				<tr>
					<th><font color="#000000">Test Name</font></th>
					<th><font color="#000000">Status</font></th>
					<th><font color="#000000">Description</font></th>
					<th><font color="#000000">Keywords</font></th>
					<th><font color="#000000">Used by Institutes</font></th>
					<th><font color="#000000">Used by Corporate</font></th>
					<th><font color="#000000">Points Earned</font></th>
				</tr>
			</thead>
			<?php
				$objDB->PopulateContributorTests($user_id);
			?>
			<tfoot>
				<tr>
					<th><font color="#000000">Test Name</font></th>
		...
		<script type="text/javascript">
			$(window).load(function(){
				...
				$("#dt_contrib_test_status").show();
				
				var page_hgt = objUtils.AdjustHeight("dt_contrib_test_status");
				$('#platform', window.parent.document).height(page_hgt+200);
			});
			
			objTbl = $('#dt_contrib_test_status').dataTable( {
