	    	...
	    	"oTableTools": {
	            "aButtons": [
					...
					},
					{
						...
						"fnClick": function() {
							bEnableAll = true;
							$("#enable_info_modal_body").html("You are charged nothing for for this feature as well, an effort to promote ourselves <i class='icon-smiley'></i>.");
	...
	<body>
		...
		<script type="text/javascript">	
			...
			function ShowInfoModal(obj, bAll)
			{
				current_obj = obj;	
				bEnableAll = false;
				$("#enable_info_modal_body").html("You are charged nothing for this feature as well, an effort to promote ourselves <i class='icon-smiley'></i>.");
				$("#enable_cost_modal").modal('show');
			}
