...
<body>
	...
	if(strcasecmp($status, "success")==0)
	{
		...
		$message =  sprintf("Thank you for buying tests. Your transaction id for current transaction is: '%s' . ", $transaction_id);
	...
	echo "You have successfully baught tests.";	
	...
	$message = "No Transaction generated by Payu Money. Please contact support if you have paid and seeing this message.";	
...
?>
  ...
  <div 	class="col-lg-6 col-md-4 col-sm-4 col-sm-offset-1 col-md-offset-1 col-lg-offset-5  noprint">
								...
								<a class="btn btn-success"  href="../../search-results.php">
										Continue Shopping &nbsp;&nbsp; <i class="fa fa-shopping-cart"
											aria-hidden="true"></i>
									</a><a class="btn btn-success"  href="mypurchase.php">
										Continue Shopping &nbsp;&nbsp; <i class="fa fa-shopping-bag"
											aria-hidden="true"></i>
									</a>
...
<?php }
	...
	<div class="alert alert-info  col-xs-6 col-sm-6 col-lg-8">
  <?php echo $message ?>
  </div>
