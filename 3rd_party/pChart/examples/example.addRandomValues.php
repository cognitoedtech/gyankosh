<?php   
 ...
 //$myPicture->render("pictures/example.addRandomValues.png");
 if ( $myPicture->TransparentBackground ) { imagealphablending($myPicture->Picture,false); imagesavealpha($myPicture->Picture,true); }
 $pdf->GDImage($myPicture->Picture,30,20,140);
 $pdf->Output('some.pdf');
?>