...
var scrolltotop={
	...
	controlHTML: '<img src="'+imageUpArrowIncludeBasePath+'/images/arrow-up.png" style="filter:alpha(opacity=70); -moz-opacity:0.7;" width="100"/>', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
