...
$.widget("db.jWizard", {
    ...
    _updateTitle: function () {
        ...
        if ($title) {
            $title.text(this.$current.data("jwizard-heading"));
        }
    },
    ...
    _buildSteps: function () {
        ...
        $steps.addClass("jw-step").each(function () {
            ...
            if (title) {
                ...
                $step.data("jwizard-heading", heading);
            }
        });
    ...
    _destroySteps: function () {
        this.$steps.show()
            ...
            .removeData("jwizard-title").removeData("jwizard-heading")
            .removeClass("jw-step");
    ...
    _updateMenu: function () {
        ...
        this.$menu.children("li")
            .removeClass("ui-state-highlight ui-state-default")
            .eq(index).addClass("ui-state-highlight").end()
            .slice(index).addClass("ui-state-default");
    },
    ...
    _disableButtons: function () {
        this.element.find(".jw-footer").find("button").addClass("ui-state-default");
    },

    _enableButtons: function () {
        this.element.find(".jw-footer").find("button").removeClass("ui-state-default");
    },
